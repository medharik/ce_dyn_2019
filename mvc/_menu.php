            ...
            <div class="collapse navbar-collapse flex-row-reverse" id="navbarNavDropdown">
              ...
              <li class="nav-item dropdown notifications-menu">
                <a class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <span class="label label-warning bg-warning"><?php if(isset($_SESSION['panier'])) echo count($_SESSION['panier']); else echo 0?></span>
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <ul class="dropdown-menu-over list-unstyled">
                    <li class="header-ul text-center">Votre Panier</li>
                    <li>
                      <!-- inner menu: contains the actual data -->
                      <ul class="menu list-unstyled">

                      <?php if(isset($_SESSION['panier']))  foreach($_SESSION['panier'] as $p) { ?>
                        <li>
                          <a href="#">
                            <i class="fa fa-users text-aqua"></i> <?=$p['libelle']?>  <?=$p['prix']?>DHS 
                          </a>
                        </li>
                    ...
                    <li class="footer-ul text-center"><a href="vider_panier.php">Vider le panier</a></li>
                    <li class="footer-ul text-center"><a href="panier.php">consulter le panier</a></li>
                  </ul>
                </div>
              </li>
